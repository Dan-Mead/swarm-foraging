...
function data_conversion()
	...
	if goal == "target" and beacon.base.distance then
		...
		broadcast_data[9] = robot.id_number						-- currently unused
		
	elseif goal == "base" and beacon.target.distance then
		...
		broadcast_data[9] = robot.id_number
